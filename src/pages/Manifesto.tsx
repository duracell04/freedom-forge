      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        <div className="space-y-12">
          ...
          <div className="text-center space-y-6 pb-12 border-b border-freedom-blue/20">
            ...
            <p className="text-2xl md:text-3xl text-freedom-blue font-light">
              Why Your AI Should Be Also Known As Freedom
            </p>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4 text-lg text-foreground/80 leading-relaxed">
              <p>I watched OpenAI become ClosedAI.<br />
              I watched our thoughts become their training data.<br />
              I watched privacy policies change overnight.<br />
              I watched AI become surveillance with a smile.</p>
              
              <p className="font-bold text-foreground">I'm building the alternative.</p>
              
              <p>This is AKAFreedom — AI that's Also Known As Freedom.<br />
              My initials are on this project because I personally guarantee your cognitive sovereignty.</p>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-6">
              {[
                { phase: "Phase 1: Prove It's Possible", desc: "Build AI that runs entirely on your phone. No cloud, no surveillance, no compromise." },
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-6 pt-6">
              ...
              <div className="space-y-4 text-lg text-foreground/80">
                <p>Every day we wait, surveillance AI becomes more normalized.<br />
                Every day we wait, more thoughts are harvested.<br />
                Every day we wait, alternatives become harder to imagine.</p>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-foreground/80">AKAFreedom isn't trying to become the next tech giant. We're trying to prevent tech giants from owning human cognition.</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-foreground/80">This project will never be acquired. Never go public. Never compromise. My initials are on it as a personal guarantee.</p>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-secondary/20 border-border p-6">
                ...
                <p className="text-lg text-foreground/80">The idea of sending thoughts to corporate servers seems as antiquated as fax machines.</p>
              </Card>
          ...
          <section className="space-y-6 text-center">
            ...
            <div className="py-8">
              <Link to="/">
                <Button size="lg" className="text-xl px-12 py-8 bg-gradient-to-r from-rebel-red to-[hsl(var(--rebel-red-end))] hover:from-[hsl(var(--rebel-red-end))] hover:to-rebel-red text-foreground font-bold uppercase tracking-wider">
            ...
            <div className="space-y-4 text-lg text-foreground/80">
              <p>Together, we're building cognitive sovereignty.<br />
              One device at a time.<br />
              One mind at a time.<br />
              One free human at a time.</p>
            </div>
          </section>
          ...
          <section className="space-y-6">
            <Card className="bg-card/30 border-border p-8">
              ...
              <p className="text-lg text-center text-foreground/80">
                The best time to build sovereign AI was before surveillance AI existed.<br />
                The second best time is now.
              </p>
              <p className="text-xl font-bold text-center text-freedom-blue mt-6">
